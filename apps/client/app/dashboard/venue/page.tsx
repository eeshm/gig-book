        ...
        {isEditing ? (
          ...
          <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="flex items-center justify-between px-6 py-4">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-mono text-xl font-bold text-amber-400">
                          {profile.capacity}
                          <span className="text-muted-foreground ml-1 font-[family-name:var(--font-family-manrope)] text-xs font-normal">
                            people
                          </span>
                        </span>
                      </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border-border/40 bg-card rounded-xl border p-5">
                <h4 className="text-muted-foreground mb-3 font-[family-name:var(--font-family-oswald)] text-xs font-semibold tracking-widest uppercase">
                  Quick Actions
                </h4>
                <div className="space-y-2">
                  <Link href="/artists" className="block w-full">
                    <Button className="h-9 w-full rounded-lg border border-amber-400/40 bg-amber-400/10 text-xs font-medium text-amber-400 transition-all hover:bg-amber-400/20">
                      Browse Artists
                    </Button>
                  </Link>
