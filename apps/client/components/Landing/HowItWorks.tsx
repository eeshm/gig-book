...
const HowItWorks = () => {
    return (
        <div className="w-full p-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-sm mx-auto sm:max-w-md md:max-w-2xl">
                {/* For Artists */}
                <div className="bg-black rounded-lg p-8 space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            <MoveRight width={12} className="text-primary"/>
                            <div>
                                <h4 className="font-semibold text-white mb-1">Get Discovered</h4>
                        ...
                        <div className="flex gap-2">
                            <MoveRight width={12} className="text-primary"/>
                            <div>
                                <h4 className="font-semibold text-white mb-1">Manage Bookings</h4>
                ...
                {/* For Venues */}
                <div className="bg-primary rounded-lg p-8 space-y-8">
                    <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="space-y-2">
                        <div className="flex gap-2">
                            ...
                            <div>
                                <h4 className="text-black mb-1">List Your Venue</h4>
                        ...
                        <div className="flex gap-2">
                            <MoveRight width={12} className="text-black"/>
                            <div>
                                <h4 className="text-black mb-1">Browse Artists</h4>
                        ...
                        <div className="flex gap-2">
                            <MoveRight width={12} className="text-black"/>
                            <div>
                                <h4 className="text-black mb-1">Book & Host</h4>
                    ...
                    <Link href="/register?role=venue">
                        <Button size="lg" className="mt-0 w-full rounded-xl bg-white text-primary bg-black">Join as Venue</Button>
                    </Link>
                </div>
            </div>
        </div>
