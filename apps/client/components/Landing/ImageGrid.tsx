      ...
      <div className="grid grid-cols-2 md:grid-cols-4">
        <Column>
          <Card
            ...
            alt="Jazz Band Performing"
            className="md:rounded-tl-3xl"
...
const Card = ({
  ...
  return (
    <motion.div
      className={cn("group relative mx-1 my-2 overflow-hidden shadow-sm", className)}
      style={{
        y,
        rotate,
        scale,
    ...
    >
      <Image
        ...
        width={300}
        height={200}
        className={cn("transition-transform duration-300 ease-in-out hover:scale-[1.05]")}
      />
      {/* Overlay effect on scroll */}
      <motion.div
        className="pointer-events-none absolute inset-0 bg-gradient-to-br from-black/90 to-black/20"
        style={{
          opacity: useTransform(
            scrollProgress,
            [0.2 + cardDelay, 0.4 + cardDelay, 0.6 + cardDelay],
            [0, 0.5, 0]
          ),
        }}
      />
